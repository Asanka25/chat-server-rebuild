...
public class ResponseTypes {
    ...
    public static final String ROOM_CREATE_APPROVAL_REPLY = "roomcreateapprovalreply";
    public static final String CLIENT_ID_APPROVAL_REPLY = "clientidapprovalreply";
